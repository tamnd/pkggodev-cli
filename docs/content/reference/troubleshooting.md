...
Most of these come down to network reality or how pkggodev serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pkggodev rate-limits like any public site. gopkg already paces
...
Where a surface is gated, gopkg reads a cookie or token you supply
...
`gopkg`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gopkg actually did
